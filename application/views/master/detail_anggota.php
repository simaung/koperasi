            ...
            <div class="col-6">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="tgl_masuk" data-target-input="nearest">
                            <input type="text" class="form-control datetimepicker-input tanggal_fmt" data-target="#tgl_masuk" name="tgl_masuk" value="<?php echo tgl_indo_simple($anggota->tgl_masuk); ?>" disabled />
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="namaAnggota" name="nama_anggota" value="<?php echo $anggota->nama_anggota; ?>" disabled>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Alamat : </label>
                        <textarea class="form-control" name="alamat" disabled><?php echo $anggota->alamat_anggota; ?></textarea>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label">Nomor Telepon :</label>
                        <input type="text" class="form-control" name="telp" data-inputmask="'mask': ['9999-9999-999[99]']" data-mask value="<?php echo $anggota->telp; ?>" disabled>
                    </div>
                </div>
            </div>
            <div class="col-6">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tempat_lahir" value="<?php echo ucfirst($anggota->tempat_lahir); ?>" disabled>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <div class="input-group date" id="tgl_lahir" data-target-input="nearest">
                            <input type="text" class="form-control datetimepicker-input tanggal_fmt" data-target="#tgl_lahir" name="tgl_lahir" value="<?php echo tgl_indo_simple($anggota->tgl_lahir); ?>" disabled>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="pekerjaan" value="<?php echo $anggota->pekerjaan; ?>" disabled>
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
            ...
            <div class="col-12">
                ...
                <div class="col-12">
                    <div class="form-group float-right">
                        <button class="btn btn-sm btn-danger" onclick="pengajuanKeluar()">Pengajuan Keluar</button>
                        <button class="btn btn-sm btn-info">Edit Anggota</button>
                    </div>
                </div>
            </div>
        </div>
