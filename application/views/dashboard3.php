               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo base_url('dashboard/index/3'); ?>" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Dashboard v3</p>
                                    </a>
                                </li>
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-striped table-valign-middle">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="<?= base_url('assets'); ?>/vendor/AdminLTE-3.0.5/dist/img/default-150x150.png" alt="Product 1" class="img-circle img-size-32 mr-2">
                                                    Some Product
                                                </td>
                                                <td>$13 USD</td>
                                                <td>
